 ...
 *
 */
public class Conf extends NoAuthReqBaseCommand {
 ...
 RFC 2228                FTP Security Extensions             October 1997
	...
	CONFIDENTIALITY PROTECTED COMMAND (CONF) 
      ...
      The argument field of CONF is a Telnet string consisting of a 
      base 64 encoded "confidential"      message produced by a 
      security mechanism specific confidentiality procedure. 
