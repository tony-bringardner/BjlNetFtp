 ...
 *
 */
public class NotAuthError  extends NoAuthReqBaseCommand {
	...
	/* 
	 * Used when a user has attempted a command that they
	...
	public void execute(FtpRequestProcessor processor, IRequestContext context) throws IOException {
		processor.reply(REPLY_533_USER_NOT_AUTHORIZED,"User not authorized for "+context.getCommandLine());
	}
